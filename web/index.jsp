...
<html>
    ...
    <body>
        ...
        <section class="about" id="about">
            <div class="about-img">
                <img src="img/yeshi-kangrang-wTD1-_u8x1g-unsplash.jpg">
        ...
        <section class="services" id="services">
            ...
            <div class="services-content">
                <div class="row">
                    <div class="s-img">
                        <img src="img/yellow-black-sign-taxi-placed-top-car-night.jpg">
                    </div>
                ...
                <div class="row">
                    <div class="s-img">
                        <img src="img/courier-girl-sitting-car.jpg">
                    </div>
