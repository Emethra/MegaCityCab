...
public class UserDAOTest {
    ...
    public void testUserRegister_Successful() throws SQLException {
        ...
        User user = new User();
        user.setName("Emethra");
        user.setAddress("5,Nirmala Mawatha,Panadura");
        user.setNIC("200069902353");
        user.setemail("emethranethmini@gmail.com");
        user.setpassword("emi123");
        ...
        try (PreparedStatement ps = testConn.prepareStatement("SELECT * FROM user WHERE email = ?")) {
            ...
            assertEquals("Name should match", "Emethra", rs.getString("name"));
        }
    ...
    public void testLoginUser_Successful() throws SQLException {
        ...
        User user = new User("Emethra", "5,Nirmala Mawatha,Panadura", "200069902353", "emethranethmini@gmail.com", "emi123");
        userDAO.userRegister(user);
        System.out.println("Inserted test user for login.");

        User loggedInUser = userDAO.loginUser("emethranethmini@gmail.com", "emi123");
        ...
        assertEquals("Email should match", "emethranethmini@gmail.com", loggedInUser.getemail());
        assertEquals("Name should match", "Emethra", loggedInUser.getName());
    ...
    public void testLoginUser_InvalidCredentials() throws SQLException {
        ...
        User user = new User("Emethra", "5,Nirmala Mawatha,Panadura", "200069902353", "emethranethmini@gmail.com", "testpass");
        userDAO.userRegister(user);
        System.out.println("Inserted test user for invalid login test.");

        User loggedInUser = userDAO.loginUser("emethranethmini@gmail.com", "Emethra");
    ...
    public void testGetUserCount_Successful() throws SQLException {
        ...
        User user1 = new User("Emethra", "5,Nirmala Mawatha,Panadura", "200069902353", "emethranethmini@gmail.com", "emi123");
    ...
    public void testGetAllUsers_Successful() throws SQLException {
        ...
        assertEquals("First user name should match", "Emethra", users.get(0).getName());
    ...
    public void testGetUserById_Successful() throws SQLException {
        ...
        try (PreparedStatement ps = testConn.prepareStatement("SELECT id FROM user WHERE email = ?")) {
            ...
            assertEquals("Name should match", "Emethra", retrievedUser.getName());
            assertEquals("Email should match", "emethranethmini@gmail.com", retrievedUser.getemail());
        }
    ...
    public void testUpdateUser_Successful() throws SQLException {
        ...
        try (PreparedStatement ps = testConn.prepareStatement("SELECT id FROM user WHERE email = ?")) {
            ...
            assertEquals("Updated name should match", "Emethra Nethmini", updatedUser.getName());
            assertEquals("Updated email should match", "emethranethmini@gmail.com", updatedUser.getemail());
        }
