...
public class BookingDAOTest {
    ...
    public void testSaveBooking_Successful() throws SQLException {
        ...
        booking.setName("Emethra Nethmini");
        booking.setEmail("emethranethmini@gmail.com");
        booking.setAddress("5,Nirmala Mawatha,Panadura");
        booking.setPhno("076115682");
        ...
        booking.setBookingDate("2025-03-16");
        ...
        try (PreparedStatement ps = testConn.prepareStatement("SELECT * FROM booking WHERE email = ?")) {
            ps.setString(1, "emethranethmini@gmail.com");
            ...
            assertEquals("Name should match", "Emethra Nethmini", rs.getString("name"));
        }
    ...
    public void testSaveBooking_WithDriverId() throws SQLException {
        ...
        try (PreparedStatement ps = testConn.prepareStatement(
            ...
            try (PreparedStatement ps2 = testConn.prepareStatement("SELECT driver_id FROM booking WHERE email = ?")) {
                ps2.setString(1, "emethranethmini@gmail.com");
    ...
    public void testGetAllContact_Successful() throws SQLException {
        ...
        Booking booking1 = new Booking("Emethra Nethmini", "emethranethmini@gmail.com", "5,Nirmala Mawatha,Panadura", "076115682", "Bambalapitiya", "Nugegoda", "Test Booking", "1200", 1, "Pending", null, null, "2025-03-16");
        ...
        assertEquals("First booking name should match", "Emethra Nethmini", bookings.get(0).getName());
    ...
    public void testGetAllBookings_Successful() throws SQLException {
        ...
        assertEquals("First booking email should match", "emethranethmini@gmail.com", bookings.get(0).getEmail());
    ...
    public void testGetContactById_Successful() throws SQLException {
        ...
        Booking booking = new Booking("Emethra Nethmini", "emethranethmini@gmail.com", "5,Nirmala Mawatha,Panadura", "076115682", "Bambalapitiya", "Nugegoda", "Test Booking", "1200", 1, "Pending", null, null, "2025-03-15");
        ...
        try (PreparedStatement ps = testConn.prepareStatement("SELECT id FROM booking WHERE email = ?")) {
            ...
            assertEquals("Name should match", "Emethra Nethmini", retrievedBooking.getName());
            assertEquals("Email should match", "emethranethmini@gmail.com", retrievedBooking.getEmail());
        }
    ...
    public void testUpdateBooking_Successful() throws SQLException {
        ...
        Booking booking = new Booking("Emethra Nethmini", "emethranethmini@gmail.com", "5,Nirmala Mawatha,Panadura", "076115682", "Bambalapitiya", "Nugegoda", "Test Booking", "1200", 1, "Pending", null, null, "2025-03-16");
        bookingDAO.saveBooking(booking);
    ...
    public void testGetTotalBookingAmount_Successful() throws SQLException {
        ...
        Booking booking1 = new Booking("Ramosh Drushal", "emethranethmini@gmail.com", "5,Nirmala Mawatha,Panadura", "076115682", "Bambalapitiya", "Nugegoda", "Test Booking", "1200", 1, "Pending", null, null, "2025-03-16");
